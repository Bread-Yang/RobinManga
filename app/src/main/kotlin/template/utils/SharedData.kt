...
/**
 * This singleton is used to share some objects whitin the application, useful to communicate
 * different pars of the app.
 *
...
object SharedData {
     ...
     */
    fun <T : Any> remove(classType: Class<T>) = get(classType)?.apply {
