...
object LocaleHelper {
    ...
    /**
     * The currently applied locale. Used to avoid losing the selected language after a non local
    ...
    fun updateConfiguration(wrapper: ContextThemeWrapper) {
        // ContextThemeWrapper 教程 : https://medium.com/@ali.muzaffar/which-context-should-i-use-in-android-e3133d00772c
