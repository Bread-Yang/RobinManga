...
class CatalogueSearchAdapter(val controller: CatalogueSearchController) :
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        allBoundViewHolders.forEach {
            saveHolderState(it, holdersBundle)
        }
    ...
    /**
     * Restores the view state of the given holder. 参考 : https://www.cnblogs.com/dongweiq/p/4530178.html
     *
