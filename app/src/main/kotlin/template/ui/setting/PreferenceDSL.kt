...
/**
 * Kotlin DSL 教程 :
 * Part1 : https://proandroiddev.com/writing-dsls-in-kotlin-part-1-7f5d2193f277
 * Part2 : https://proandroiddev.com/writing-dsls-in-kotlin-part-2-cd9dcd0c4715
 */
...
// inline, noline, crossline 区别 : https://android.jlelse.eu/inline-noinline-crossinline-what-do-they-mean-b13f48e113c2
inline fun Preference.onClick(crossinline block: () -> Unit) {
    setOnPreferenceClickListener { block(); true }
}

inline fun Preference.onChange(crossinline block: (Any?) -> Boolean) {
    setOnPreferenceChangeListener { preference, newValue -> block(newValue) }
}
