...
import template.ui.library.LibraryController
...
class SettingsAdvancedController : SettingsController() {
    ...
    private val network: NetworkHelper = App.app.lazyNetworkHelper.get()

    private val chapterCache: ChapterCache = App.app.lazyChapterCache.get()

    private val db: DatabaseHelper = App.app.lazyDatabaseHelper.get()
    ...
    private fun clearChapterCache() {
        ...
        Observable.defer { Observable.fromIterable(files.asIterable()) }
                .doOnNext {
                    if (chapterCache.removeFileFromCache(it.name)) {
                        deletedFiles++
                    }
                }
