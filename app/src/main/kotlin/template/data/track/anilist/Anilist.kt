...
class Anilist(private val context: Context, id: Int) : TrackService(id) {
    ...
    private val interceptor by lazy {
        AnilistInterceptor(this, getPassword())
    }

    private val api by lazy {
        AnilistApi(client, interceptor)
    }

    private val scorePreference: Preference<String> = preferencesHelper.anilistScoreType()
    ...
    override fun logout() {
        super.logout()
        preferencesHelper.trackToken(this).delete()
        interceptor.setAuth(null)
    }

    fun saveOAuth(oAuth: OAuth?) {
        preferencesHelper.trackToken(this).set(gson.toJson(oAuth))
    }
