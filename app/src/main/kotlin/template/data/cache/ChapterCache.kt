...
import template.extensions.fromJson
 ...
 */
class ChapterCache(private val context: Context, private val gson: Gson) {
...
//            File(context.cacheDir, PARAMETER_CACHE_DIRECTORY),
    ...
    fun getPageListFromCache(chapter: Chapter): Observable<List<Page>> {
        return Observable.fromCallable {
            ...
            // Convert JSON string to list of object. Throws an exception if snapshot is null
